...
INSERT INTO request_method (name) VALUES ('post')   ON CONFLICT DO NOTHING;
INSERT INTO request_method (name) VALUES ('put')    ON CONFLICT DO NOTHING;
INSERT INTO request_method (name) VALUES ('delete') ON CONFLICT DO NOTHING;
